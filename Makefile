...
#  opp_makemake -f -r --deep -o CastaliaBin -u Cmdenv -P /home/israel/Dropbox/Castalia-3.2 -M release -X Simulations -X out -X bin
#
...
INCLUDE_PATH = \
    -I. \
    -Ielsevier-template \
    -Ielsevier-template/img \
    -Ielsevier-template/refs \
    -Isim-param-set \
    -Isrc \
    -Isrc/helpStructures \
    -Isrc/node \
    ...
    -Isrc/node/communication/routing/myRouting \
    -Isrc/node/mobilityManager \
    -Isrc/node/mobilityManager/noMobilityManager \
    -Isrc/node/mobilityManager/randomWalk \
...
OBJS = \
    ...
    $O/src/node/communication/routing/myRouting/MyRoutingControl_m.o \
    $O/src/node/communication/routing/myRouting/MyRoutingPacket_m.o \
...
MSGFILES = \
    ...
    src/node/communication/routing/myRouting/MyRoutingControl.msg \
    src/node/communication/routing/myRouting/MyRoutingPacket.msg \
...
clean:
	...
	$(Q)-rm -f ./*_m.cc ./*_m.h
	$(Q)-rm -f elsevier-template/*_m.cc elsevier-template/*_m.h
	$(Q)-rm -f elsevier-template/img/*_m.cc elsevier-template/img/*_m.h
	$(Q)-rm -f elsevier-template/refs/*_m.cc elsevier-template/refs/*_m.h
	$(Q)-rm -f sim-param-set/*_m.cc sim-param-set/*_m.h
	...
	$(Q)-rm -f src/node/communication/routing/myRouting/*_m.cc src/node/communication/routing/myRouting/*_m.h
	...
	$(Q)-rm -f src/node/mobilityManager/randomWalk/*_m.cc src/node/mobilityManager/randomWalk/*_m.h
...
depend:
	...
	$(Q)$(MAKEDEPEND) $(INCLUDE_PATH) -f Makefile -P\$$O/ -- $(MSG_CC_FILES)  ./*.cc elsevier-template/*.cc elsevier-template/img/*.cc elsevier-template/refs/*.cc sim-param-set/*.cc src/*.cc src/helpStructures/*.cc src/node/*.cc src/node/application/*.cc src/node/application/valueReporting/*.cc src/node/communication/*.cc src/node/communication/mac/*.cc src/node/communication/mac/bypassMac/*.cc src/node/communication/radio/*.cc src/node/communication/routing/*.cc src/node/communication/routing/bypassRouting/*.cc src/node/communication/routing/multipathRingsRouting/*.cc src/node/communication/routing/myRouting/*.cc src/node/mobilityManager/*.cc src/node/mobilityManager/noMobilityManager/*.cc src/node/mobilityManager/randomWalk/*.cc src/node/resourceManager/*.cc src/node/sensorManager/*.cc src/physicalProcess/*.cc src/physicalProcess/customizablePhysicalProcess/*.cc src/wirelessChannel/*.cc
...
$O/src/node/communication/routing/myRouting/MyRouting.o: src/node/communication/routing/myRouting/MyRouting.cc \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/CastaliaMessages.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/routing/myRouting/MyRouting.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/communication/routing/myRouting/MyRoutingControl_m.h \
  src/helpStructures/TimerService.h \
  src/node/resourceManager/ResourceManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/node/communication/mac/MacPacket_m.h \
  src/node/communication/routing/myRouting/MyRoutingPacket_m.h \
  src/node/communication/routing/RoutingPacket_m.h \
  src/node/application/ApplicationPacket_m.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/node/communication/radio/Radio.h \
...
$O/src/node/mobilityManager/randomWalk/randomWalk.o: src/node/mobilityManager/randomWalk/randomWalk.cc \
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/mobilityManager/MobilityManagerMessage_m.h \
  src/node/mobilityManager/randomWalk/randomWalk.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/CastaliaMessages.h \
  src/wirelessChannel/WirelessChannelMessages_m.h
