...
# Options: SampleCentral, DropRandom / 20, 35, 50, 100 / [1:30]
...
evalMetric <- "Coverage"
bufferSize <- 1000
sampleRate <- (100*bufferSize)/(fieldLenght^2) # 10% of data (1000 samples in a 100x100 grid)

if(length(args) != 3) {
	print("WARNING: Number of parameters does not match, using defaults.")
	samplingAlgorithm <- "SampleCentral"
	numNodes <- evalParameter <- 50
	seed <- 1
}
