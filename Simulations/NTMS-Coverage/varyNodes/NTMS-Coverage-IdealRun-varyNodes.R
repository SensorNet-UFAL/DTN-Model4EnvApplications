...
for(n_sensores in c(20,35,50,100)) {
...
write.table(sumCoverageOGK, "coverageOGK-varyNodes.dat")
write.table(sumCoverageDL, "coverageDL-varyNodes.dat")
write.table(sumCoverageDF, "coverageDF-varyNodes.dat")
write.table(sumCoverageDR, "coverageDR-varyNodes.dat")
write.table(sumCoverageDN, "coverageDN-varyNodes.dat")
