...
# Example: nohup Rscript pairIndexes.R SampleCentral 1000 1 &
# Options: SampleCentral, DropRandom / 1000, 1500, 2000, 2500

evalType <- "varyBuffer" # Experiment under study
...
##############################################################################################################
	...
	# Israel, 2014
		...
		r = seed
		n_sensores = numNodes
		percentualReducao = evalParameter
