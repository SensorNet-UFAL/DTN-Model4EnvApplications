...
# Example: nohup Rscript pairIndexes-Time.R SampleCentral 5000 &
# Options: SampleCentral, DropRandom / 1000, 2500, 5000, 10000

evalType <- "varySpeed" # Experiment under study

args <- commandArgs(TRUE)
args
samplingAlgorithm <- args[1] 
evalParameter <- as.double(args[2]) 
