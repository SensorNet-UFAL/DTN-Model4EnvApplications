...
# Example: nohup Rscript pairIndexes-Power.R SampleCentral 0dBm &
# Options: SampleCentral, DropRandom / 0dBm, -10dBm, -15dBm, -25dBm

evalType <- "varyPower" # Experiment under study

args <- commandArgs(TRUE)
args
samplingAlgorithm <- args[1] 
evalParameter <- args[2]
